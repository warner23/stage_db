...
$(".editor").each(function(i,v){
    console.log(i);
    console.log(v);
    var editedContents =  encodeURIComponent($(this,".editor").html() );
    data.UserData.contents.push(editedContents);
});

    // var sections = new Array();
$(".editInput").each(function(){
    var section_title =encodeURIComponent($(this,".editInput").val() );
    data.UserData.sections.push(section_title);
});

//var buttons = new Array();
$(".editButtonInput").each(function(){
     var button_title = encodeURIComponent($(this,".editButtonInput").val() );
    data.UserData.buttons.push(button_title); 
    });
