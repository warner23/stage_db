...
class WIWebsite 
{
        ...
        public function MainMenu()
    {
        ...
        $query1->bindParam(':order', $menu_order, PDO::PARAM_INT);
        $query1->execute();
        echo '<style>.mainMenu li {
    display: inline-block;
    float: left;
}</style><div class="col-lg-9 col-md-9 col-sm-12 menu">
              <div id="nav">
                ...
                <div class="container">
                 ...
                 <img class="img-responsive cp" id="headerPic" src="WIMedia/Img/header/'. $res['logo'] . '" style="width:120px; height:120px;">
                    <button class="btn mediaPic" onclick="WIMedia.changePic()">Change Picture</button>
                        ...
                        <div class="col-ms"> 
                        <div class="zapfino"><h2><b><input type="text" id="header_content" value="' . $res['header_content'] . '"></b></h2>
                        <span class="slogan"><input type="text" id="header_slogan" value="' . $res['header_slogan'] . '"></span>
                        </div>
...
';
    ...
    public function headerSettings($settings)
    {
        ...
        $sql = "INSERT `wi_header` SET logo =:logo  WHERE  `header_id` =:header_id";
        $query = $this->WIdb->prepare($sql);
