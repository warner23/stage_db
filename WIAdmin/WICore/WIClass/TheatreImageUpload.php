...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/theatres/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/theatres/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/theatres/" . basename($_FILES['file']['name']);
