...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/company/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/company/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/company/" . basename($_FILES['file']['name']);
