...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/actor/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/actor/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIAdmin/WIMedia/Img/actor/" . basename($_FILES['file']['name']);
