...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/shows/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/shows/trailers/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/shows/trailers/" . basename($_FILES['file']['name']);
