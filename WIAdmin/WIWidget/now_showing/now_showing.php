...
<h1>' .WILang::get("welcome_") . '<span>'. $this->site->Website_Info('site_name') . '</span></h1>
	...
	public function mod_name()
	{
		$soon = "0";
		$closed = "0";
		$sql = "SELECT * FROM `wi_shows` WHERE `coming_soon`=:soon AND `closed`=:closed ORDER BY  RAND()";
        ...
        foreach ($result as $shows) {
            ...
            <span>(<a class="theatre_link" href="theatre.php" id="' . $shows['theatre_id'] . '">'. $shows['theatre'].'</a>)</span
            li>';
        }
