...
<ul>
  ...
  <div class="shows_style" id="shows">							
	...
	<script type="text/javascript" src="WICore/WIJ/WIFrontSideEditing.js"></script>';
...
if($this->user->isAdmin() OR $this->Perm->hasPermission(WISession::get('user_id'), "2", "Shows", "create") ){
