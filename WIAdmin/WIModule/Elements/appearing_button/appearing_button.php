...
$("body").on("mouseleave","#midActions", function(){
	...
	{
		echo '<div class="fBtnGroup" id="appearing_button">
...
$("body").on("mouseleave",".stageFields", function(){
  ...
  {
    $page = '<div class="fBtnGroup" id="appearing_button">
				<button type="button" id="buttonInput">Button</button>
				</div>';
  ...
  {
    $page = '<div class="fBtnGroup" id="appearing_button">
				<button type="button" id="buttonInput"><input type="text" class="editButtonInput" value="" placeholder="Button"></button>
				</div>';
