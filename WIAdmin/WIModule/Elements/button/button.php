...
$("body").on("mouseleave","#midActions", function(){
  ...
  {
    echo '<div class="fBtnGroup" id="button">
...
$("body").on("mouseleave",".stageFields", function(){
  ...
  {
    $page = '<div class="fBtnGroup" id="button">
        <button type="button" id="buttonInput">Button</button>
        </div>';
  ...
  {
    $page = '<div class="fBtnGroup" id="button">
        <button type="button" id="buttonInput"><input type="text" class="editInput" value="" placeholder="Button"></button>
        </div>';
