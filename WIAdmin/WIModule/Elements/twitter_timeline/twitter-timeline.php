...
.groupActions-' . $count . ' button {
    ...
    background-color: #fff;
      ...
      <hr>      <label>Define Column widths</label>
...
$("body").on("mouseleave","#sideAction", function(){
  ...
  public function sideActionButtons($empty, $count, $mod_drop)
  {
    ...
    if($empty === "0") {
      echo "'stageField-" . $count . "', 'stageRow-" . $count . "', 'groupConfig-".$count."', 'midgroupActions-".$count ."'";
      }else{
        echo "'stageField', 'stageRow', 'groupConfig' , 'midgroupActions'";
        }
    echo');">
    ...
    <li class="btn item item_remove" title="remove" onclick="WIPageBuilder.deleteRow(';
    if($empty === "0") {
      echo "'dropStage-". $count. "'";
      }else{
    echo "'dropStage'";
    }
    echo ');">
    ...
    public function midActionButtons($empty, $count, $mod_drop, $cloned)
  {
    echo '<ul class="midAct">
      ...
      <path d="M287.744 94.736v129.008h128v-64L512 256l-96.256 96.24v-65.488h-128V415.76h64.496L256 512l-96.256-96.24h64V286.752h-128v64.992L0 256l95.744-95.744v63.488h128V94.736h-62.496L256 0l94.752 94.736h-63.008z"></path>
          ...
          if($cloned === "yes"){
          echo 'onclick="WIPageBuilder.deleteRow(';
          if($empty === '0') {
            echo "'columnx-". $count."'";
          }else{
            echo "'columnx'";
          ...
          echo ');>';
            ...
            echo 'onclick="WIPageBuilder.Removecol("';
            if($empty === "0") {
              echo "'dropStage-". $count."'";
              }else{
                echo "'dropStage'";
...
$("body").on("mouseleave","#midActions", function(){
    ...
    public function endActionButtons($empty, $count, $mod_drop)
  {
    ...
    <li class="btn item_remove item" title="Remove" onclick="WIPageBuilder.deleteRow("';
    if($empty === "0") {
      echo "'dropStage-". $count."'";
      }else{echo "'dropStage'";
      } 
  ...
  {
    echo '<div class="fBtnGroup" id="twitter_timeline">
...
<div id="accordion">
  ...
  public function stageField($empty, $count, $mod_drop)
  {
    if($empty === "0") {
    ...
    self::endActionButtons($empty, $count, $mod_drop);
      echo '</div>
    </div>
...
$("body").on("mouseleave",".stageFields", function(){
  ...
  {
    $page = '<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  <script>
  $( function() {
...
<div id="accordion">
  ...
  <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  <script src="WICore/WIJ/wysiwyg.js"></script>
  <script>
  $( function() {
    $( "#accordion" ).accordion();
  } );
...
<div id="accordion">
  <h3><input type="text" class="editInput" value="" placeholder="Section 1"></h3>
  <div>
  <div class="wysiwyg">';
  ...
  <h3><input type="text" value="" class="editInput" placeholder="Section 2"></h3>
  <div>
 <div class="wysiwyg">';
  $this->editor->Paragraph();
  echo '</div>
  </div>
  <h3><input type="text" value="" class="editInput" placeholder="Section 3"></h3>
  <div>
    <div class="wysiwyg">';
  $this->editor->Paragraph();
  echo '</div>
  </div>
  <h3><input type="text" value="" class="editInput" placeholder="Section 4"></h3>
  <div>
<div class="wysiwyg">';
  $this->editor->Paragraph();
  echo '</div>
