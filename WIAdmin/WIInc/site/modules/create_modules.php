  ...
  <div class="site-wrap">
    ...
    <section id="main_content" class="inner">
      <form class="build-form clearfix">
        <div class="stageWrap"> 
            <ul class="droppable stage emptyStage" id="droppable" droppable="true" style="min-height: 528.594px;"></ul>
        </div>
...
<div id="tabsMenu">
          ...
          <button class="prev-group btn padd" onclick="WIPageBuilder.RotateX()" title="Prevous Group" type="button" data-toggle="tooltip" data-placement="top"><img src="WIMedia/Img/mfp-left.png"></button>
  <ul>
    <li class="fields"><a href="javascript:void(0)" class="elementsC on">Common Fields</a></li>
    <li class="fields"><a href="javascript:void(0)" aria-hidden="true" class="elementsE off">HTML Elements</a></li>
    <li class="fields"><a href="javascript:void(0)" aria-hidden="true" class="elementsL off">Layout</a></li>
  </ul>
   <button class="next-group btn padd" onclick="WIPageBuilder.Rotate()" title="Next Group" type="button" data-toggle="tooltip" data-placement="top"><img src="WIMedia/Img/mfp-right.png"></button>
...
$(document).ready(function(){
    ...
    $( "ul#draggableElement li" ).draggable({
...
$( "ul#draggableElement li" ).on( "dragstart", function( event, ui ) {
    ...
    console.log(mod_name);
      ...
      event.originalEvent.dataTransfer.setData("text", mod_name ); // required otherwise doesn't work
      console.log(mod_name);
} );


$( "ul#droppable" ).on('dragenter', function (event, ui) 
{
    event.stopPropagation();
    event.preventDefault();
    $(this).css('border', '2px solid #0B85A1');
    $('ul#droppable').prepend('<li class="stageRow" data-hover-tag="Row" data data-editing-hover-tag="Editing Row" id="dropStage"></li>');

    //$('<li class="stageRow" data-hover-tag="Row" data data-editing-hover-tag="Editing Row" id="dropStage"></li>').insertAfter('ul#droppable>li:last');
    
});

$( "ul#droppable" ).on('dragleave', function (e) 
{
    e.stopPropagation();
    e.preventDefault();
    $("li#dropStage").remove();
...
$('ul#droppable').on('dragover',function(event){
    event.preventDefault();
    event.originalEvent.dataTransfer.dropEffect = "copy"
})


$("ul#droppable").on('drop', function (event, ui) {
        event.stopPropagation();
    event.preventDefault();
    $("li#dropStage").remove();
var mod_name = event.originalEvent.dataTransfer.getData("text");

    WIMod.dropping(mod_name,mod_name, "droppable");
});
