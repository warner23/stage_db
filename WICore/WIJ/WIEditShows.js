$(document).ready(function(){
	WIEditShows.cat();
  WIEditShows.haveshows();
	//WIEditShows.resources();
...
WIEditShows.select_cat = function(){
    $.ajax({
      url      : "WICore/WIClass/WIAjax.php",
      method   : "POST",
      data     : {
...
WIEditShows.resources = function(){
		$.ajax({
			url      : "WICore/WIClass/WIAjax.php",
			method   : "POST",
			data     : {
...
WIEditShows.PostSlider = function(){
	    var day = $(".day").html();
...
WIEditShows.PostNoMedia = function(){
  var cat_id =  $("#cat").attr('cat_id');
	var day = $(".day").html();
	var month = $(".month").html();
  var user = $("#user").html();
...
WIEditShows.PostImage = function(){
...
WIEditShows.PostAudio = function(){
...
WIEditShows.PostVideo = function(){
var cat_id =  $("#cat").attr('cat_id');
    var day = $(".day").html();
  var month = $(".month").html();
...
WIEditShows.PostYouTube = function(){
  var cat_id =  $("#cat").attr('cat_id');
  var day = $(".day").html();
  var month = $(".month").html();
...
WIEditShows.slider = function(){
WIEditShows.select_cat();
WIEditShows.userRole('slideruser');
...
'<div class="submit"><a href="javascript:void(0)" onclick="WIEditShows.PostSlider()">Post</div>'+
...
WIEditShows.video = function(){
WIEditShows.select_cat();
WIEditShows.userRole('viduser');
	var nowDate		= new Date();
var nowDay		= ((nowDate.getDate().toString().length) == 1) ? '0'+(nowDate.getDate()) : (nowDate.getDate());
var nowMonth	= ((nowDate.getMonth().toString().length) == 1) ? '0'+(nowDate.getMonth()+1) : (nowDate.getMonth()+1);
var nowYear		= nowDate.getFullYear();
var formatDate	= nowDay + "." + nowMonth + "." + nowYear;
	...
	var video = ('<!-- .latest-posts start -->'+                            
        ...
        '<div class="upload-msg"></div></figure>'+                              
               ...
               '<div class="submit btn btn-primary"><a href="javascript:void(0)" onclick="WIEditShows.PostVideo()">Post</div>'+                        
                                   '</article><!-- .blog-post end -->'+
                                   '<script type="text/javascript">'+
                                   '$(document).ready(function(){'+
...
WIEditShows.image = function(){
WIEditShows.select_cat();
WIEditShows.userRole('imguser');
	var nowDate		= new Date();
var nowDay		= ((nowDate.getDate().toString().length) == 1) ? '0'+(nowDate.getDate()) : (nowDate.getDate());
var nowMonth	= ((nowDate.getMonth().toString().length) == 1) ? '0'+(nowDate.getMonth()+1) : (nowDate.getMonth()+1);
var nowYear		= nowDate.getFullYear();
var formatDate	= nowDay + "." + nowMonth + "." + nowYear;
	...
	var image = ('<!-- .latest-posts start -->'+                            
        ...
        '<div class="upload-msg"></div></figure>'+                              
               ...
               '<div class="submit btn btn-primary"><a href="javascript:void(0)" onclick="WIEditShows.PostImage()">Post</div>'+                        
                                   '</article><!-- .blog-post end -->'+
                                   '<script type="text/javascript">'+
                                   '$(document).ready(function(){'+
  'var obj = $("#dragandrophandler");'+
...
'});'+
'</script>');
	$("#shows_style").append(image);
}

WIEditShows.audio = function(){
WIEditShows.select_cat();
WIEditShows.userRole('audionuser');
	var nowDate		= new Date();
var nowDay		= ((nowDate.getDate().toString().length) == 1) ? '0'+(nowDate.getDate()) : (nowDate.getDate());
var nowMonth	= ((nowDate.getMonth().toString().length) == 1) ? '0'+(nowDate.getMonth()+1) : (nowDate.getMonth()+1);
var nowYear		= nowDate.getFullYear();
      ...
      '<figure class="post-audio" id="Post_audio">'+                 
       ...
       '<li class="post-tags fa fa-tags">'+                                               
        ...
        '</div>'+                                   
         ...
         '</div>'+                         
         '</article><!-- .blog-post end -->'+
         '<div class="submit"><a href="javascript:void(0)" onclick="WIEditShows.PostAudio()">Post</div>'+
         '<script type="text/javascript">'+
                                   '$(document).ready(function(){'+
  'var obj = $("#dragandrophandler");'+
'obj.on("dragenter", function (e) '+
...
'});'+
'</script>');
	$("#shows_style").append(audio);
}

WIEditShows.youtube = function(){
WIEditShows.select_cat();
WIEditShows.userRole('ytuser');
	var nowDate		= new Date();
var nowDay		= ((nowDate.getDate().toString().length) == 1) ? '0'+(nowDate.getDate()) : (nowDate.getDate());
var nowMonth	= ((nowDate.getMonth().toString().length) == 1) ? '0'+(nowDate.getMonth()+1) : (nowDate.getMonth()+1);
var nowYear		= nowDate.getFullYear();
            ...
            '<li class="fa fa-user">'+                                               
             ...
             '<a href="javascript:void(0)">news, </a>'+                                               
              ...
              '</ul>'+                                   
               ...
               '</div>'+  
               '<div class="submit btn btn-primary"><a href="javascript:void(0)" onclick="WIEditShows.PostYouTube()">Post</div>'+                   
               '</article>');
	$("#shows_style").append(youtube);
}

WIEditShows.theatre = function(){
WIEditShows.select_cat();
WIEditShows.userRole('user');
	var nowDate		= new Date();
var nowDay		= ((nowDate.getDate().toString().length) == 1) ? '0'+(nowDate.getDate()) : (nowDate.getDate());
var nowMonth	= ((nowDate.getMonth().toString().length) == 1) ? '0'+(nowDate.getMonth()+1) : (nowDate.getMonth()+1);
var nowYear		= nowDate.getFullYear();
var formatDate	= nowDay + "." + nowMonth + "." + nowYear;
	...
	var theatre = ('<article class="post_container" id="noMediaPost">'+                             
         '<div class="post-info">'+                                    
         '<div class="post-date">'+                                        
         '<span class="day">'+nowDay+'</span>'+                                        
         '<span class="month">'+nowMonth+'</span>'+                                    
            ...
            '<li class="fa fa-user">'+                                               
             ...
             '<a href="javascript:void(0)">news, </a>'+                                               
              ...
              '</ul>'+                                   
               ...
               '<div class="read-more"></div> '+                            
               '</div>'+  
               '<div class="submit btn btn-primary"><a href="javascript:void(0)" onclick="WIEditShows.PostNoMedia()">Post</div>'+                   
               '</article>');
         $("#shows_style").append(theatre);
}

WIEditShows.haveshows = function(){
...
WIEditShows.userRole = function(colID){
